...
| Path | Purpose |
| :--- | :--- |
| **`companies/`** | One `.yaml` file per **remote-first** employer: name, sectors, careers URL, LinkedIn company id, locations, work policy, and related fields. Filenames are a slug (e.g. `my-company.yaml`); each file is a single mapping. |
