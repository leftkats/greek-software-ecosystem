...
_USER_AGENT = (
    "awesome-greek-software-engineering/1.0 "
    "(+https://github.com/leftkats/awesome-greek-software-engineering; "
...
def main() -> int:
    ...
    with OUTPUT_PATH.open("w", encoding="utf-8") as f:
        f.write(
            ...
            "(generated by awesome_greek_software_engineering.fetch_workable_counts)\n"
        )
        yaml.dump(
            out,
            f,
